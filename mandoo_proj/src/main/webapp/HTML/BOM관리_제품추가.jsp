...
<body>
    ...
    <div class="content">
        ...
        <div class="sr_mandoo">
            <!-- 되돌아가기 이미지 -->
            <img class="imgstyle back" src="${pageContext.request.contextPath}/image/뒤로가기.png" title="뒤로가기">
            <!-- save이미지 -->
            <img class="imgstyle save" src="${pageContext.request.contextPath}/image/save.webp" title="저장">
        </div>
        ...
        <div class="toRight">
            <div></div>
            <img src="${pageContext.request.contextPath}/image/plus.png" class="ingrebutt mho imgstyle" title="한줄추가" onclick="addIngredient()">
        </div>
