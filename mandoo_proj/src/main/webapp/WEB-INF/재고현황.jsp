...
<body>
	...
	<div id="popup-overlay" class="popup-overlay">
		<div class="popup-content">
			...
			<h2>재고 추가</h2>
			품목코드 : <input type="text" id="item-code" placeholder="품목코드">
			<br> 품목명 : <input type="text" id="item-name" placeholder="품목명">
			<br> 이미지코드 : <input type="text" id="item-image"
				placeholder="이미지코드"> <br> 재고수량 : <input type="number"
				id="item-stock" placeholder="재고수량"> <br> 가용수량 : <input
