...
<body>
    <div class="category">
        ...
        <div class="category-item">
            <a href="${pageContext.request.contextPath}/indexemp.jsp" class="category-link">
        ...
        <div class="category-item">
            <a href="${pageContext.request.contextPath}/작업지시서(작업자용)emp.jsp" class="category-link title">생산계획</a>
        </div>
        ...
        <div class="main">
            ...
            <div class="m_llist">
                <div class="flex round page-item">
                    <div>
                        <a class="mho" href="${pageContext.request.contextPath}/작업지시서emp.jsp">2024-050</a>
                    </div>
                    <div>2024.04.18</div>
                    <div>2024.07.23</div>
