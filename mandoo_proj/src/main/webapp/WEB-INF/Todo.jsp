         ...
         <div class="modal-content">
            <div>
               ...
               <span class="close" onclick="closeModal()"><img
                  src="${pageContext.request.contextPath}/image/close.png"></span>
            </div>
            ...
            <div id="eventDetail" style="display: none;">
               ...
               <button id="editEventButton" class="edit-event"
                  onclick="editEvent()">
                  <img src="${pageContext.request.contextPath}/image/edit.png"
                     class="edit1"> <img
                     src="${pageContext.request.contextPath}/image/edit2.png"
