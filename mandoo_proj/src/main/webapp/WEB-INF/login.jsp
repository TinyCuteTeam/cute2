		...
		<div class="modal-content">
			...
			<form action="${pageContext.request.contextPath}/register" method="post"
				...
				<label for="register_user_id">아이디:</label> <input type="text"
					...
					for="register_user_pw">비밀번호:</label> <input type="password"
					name="user_pw" id="register_user_pw" required><br> <label
					for="register_user_pw_check">비밀번호 확인:</label> <input
				...
				<label for="register_user_email">이메일:</label> <input type="email"
					name="user_email" id="register_user_email" required><br>
