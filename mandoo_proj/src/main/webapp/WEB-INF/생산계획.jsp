			...
			<div class="content">
				...
				<div class="wrap">
					<div class="action-buttons">
						...
						<form id="delete-form" method="post" action="/mandoo/ProductPlan" style="display: inline;">
			...
			<div id="popup" class="popup" style="display: none;">
				<div class="popup-content">
					...
					<form id="registration-form" method="post" action="/mandoo/ProductPlan">
						<input type="hidden" name="action" value="add"> <label for="plan-number">생산계획 ID:</label><br>
						<input type="text" id="plan-number" name="plan-number" placeholder="생산계획 ID" required><br>
						<label for="item-name">생산계획 내용:</label><br> <input type="text" id="item-name" name="item-name"
							placeholder="생산계획 내용" required><br>
						<label for="plan-date">생산계획 날짜:</label><br> <input type="date" id="plan-date" name="plan-date"
							required><br> <label for="plan-end-date">종료 날짜:</label><br> <input type="date"
							id="plan-end-date" name="plan-end-date" required><br>
						<label for="production-quantity">생산 수량:</label><br> <input type="number"
							id="production-quantity" name="production-quantity" placeholder="생산 수량" required><br> <label
							for="status">생산계획
							이름:</label><br> <input type="text" id="status" name="status" placeholder="생산계획 이름"
							required><br> <br>
