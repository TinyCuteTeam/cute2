...
<body>
    ...
    <div class="content">
        ...
        <!-- 각 내용별 제목 -->
        <div class="flex m_top mfont">
            <div><strong>거래처</strong></div>
            <div><strong>발주일</strong></div>
            <div><strong>출고예정일</strong></div>
            <div><strong>박스(Box)</strong></div>
            <div><strong>개수(EA)</strong></div>
            <div><strong>단가(원)</strong></div>
        </div>
