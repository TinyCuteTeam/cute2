                    ...
                    <div id="lineModal" class="popup">
                        <div class="popup-content">
                            ...
                            <form id="line-form" method="post" action="/mandoo/Work">
                                <input type="hidden" name="action" value="start"> <input type="hidden"
                                    id="selectedWorkId" name="workId"> <label for="lineNo">라인 번호 선택:</label> <select
                                    id="lineNo" name="lineNo" required>
                ...
                <div id="popup" class="popup">
                    <div class="popup-content">
                        ...
                        <form id="registration-form" method="post" action="/mandoo/Work">
                            <input type="hidden" name="action" value="add"> <label for="workId">작업지시 NO:</label><br>
                            <input type="text" id="workId" name="workId" placeholder="작업지시 NO" required><br>

                            <label for="userId">작성자:</label><br> <input type="text" id="userId" name="userId"
                                placeholder="작성자" required><br>

                            <label for="itemCode">품목 코드:</label><br> <input type="text" id="itemCode" name="itemCode"
                                placeholder="품목 코드" required><br>

                            <label for="workWrite">작성일자:</label><br> <input type="date" id="workWrite" name="workWrite"
                                required><br> <label for="workEndate">납기일자:</label><br> <input type="date"
                                id="workEndate" name="workEndate" required><br> <label for="workName">품목명:</label><br>
                            <input type="text" id="workName" name="workName" placeholder="품목명" required><br>

                            <label for="workDo">진행상태:</label><br> <select id="workDo" name="workDo" required>
                                <option value="작업 대기">작업 대기</option>
                                <option value="작업 중">작업 중</option>
                            </select><br> <label for="productionQty">작업해야 할 수량:</label><br> <input type="number"
                                id="productionQty" name="productionQty" placeholder="작업 수량" required><br>
