...
<body>
    ...
    <div class="category">
        ...
        <!-- 카테고리 -->
        <div class="category-item">
            <a href="BOMemp.jsp" class="category-link title">BOM</a>
        </div>
    ...
    <div class="sidebar">
        <ul id="sidebar-content">
            <li><a href="BOMemp.jsp" class="category-link title">BOM(레시피관리)</a></li>
        </ul>
    </div>
    ...
    <script src="${pageContext.request.contextPath}/JS/BOMemp.js"></script>
</body>
